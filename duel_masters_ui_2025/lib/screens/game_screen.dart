...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    wsHandler = GameWebSocketHandler(
      url: 'wss://3828-213-170-209-87.ngrok-free.app/duel-masters-ws',
  ...
  Future<void> fetchGameData() async {
    ...
    final response = await http.get(
      Uri.parse('https://3828-213-170-209-87.ngrok-free.app/api/games'),
    );
                      ...
                      children: [
                        OpponentField(
                          ...
                          onConfirmAttack: (targetCard) {
                            ...
                            _attackShieldOrCreature(selectedAttacker!, targetCard);
                          },
