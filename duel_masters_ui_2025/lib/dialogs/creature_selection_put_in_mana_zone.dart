...
class CreatureSelectionForManaZoneOverlay extends StatelessWidget {
  ...
  const CreatureSelectionForManaZoneOverlay({
    super.key,
            ...
            child: Column(
              ...
              children: [
                Text(
                  isMyCreature
                      ? "Select a creature"
                      : "Opponent is selecting a creature from your battlezone ",
